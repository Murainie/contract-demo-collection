...
contract Ghost is Ownable, ERC721A {
    ...
    //Starting at 2 ether
    uint256 public DA_STARTING_PRICE = 0.001 ether; //change before commit

    //Ending at 0.1 ether
    uint256 public DA_ENDING_PRICE = 0.0001 ether;

    //Decrease by 0.05 every frequency.
    uint256 public DA_DECREMENT = 0.0001 ether;
    ...
    uint256 public DA_STARTING_TIMESTAMP = 1651670917; //please edit and remove comment

    //The final auction price.
    uint256 public DA_FINAL_PRICE;

    //WL Price
    uint256 public WLprice = 0.0005 ether;

    //The quantity for DA.
    uint256 public DA_QUANTITY = 4000; //change before commit
    ...
    address public FOUNDER_ADD = 0x2781c274c184a90bF89f1f379232D8e3Ce3b1EcC; //please edit and remove comment
    address public DEV_FUND = 0x2781c274c184a90bF89f1f379232D8e3Ce3b1EcC; //please edit and remove comment
